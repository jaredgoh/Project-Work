...
CASE
    ...
    cast(refundid as varchar) refundid,
	cast(audrate as float) audrate,
    com,
    cast(totaldiscountamount as float) totaldiscountamount,
    cast(totalpaymentamount as float) totalpaymentamount,
	cast(totaltaxamount as float) totaltaxamount,
    et
from 
